...
//#endregion
//#region node_modules/jsonlint-mod/web/jsonlint.js
var require_jsonlint = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var jsonlint = (function() {
		var require = true, module$1 = false;
		var exports$1 = {};
		var ___dougJSONParse = function() {
			...
			var number = function() {
				...
				value = +string;
				if (!isFinite(value)) error("Bad number");
				else return value;
			};
			var string = function() {
				var hex;
				...
				if (ch === "\"") while (next()) {
					...
					if (ch === "\\") {
						...
						} else if (typeof escapee[ch] === "string") value += escapee[ch];
						else break;
					} else value += ch;
				}
				error("Bad string");
			...
			var object = function() {
				...
				if (ch === "{") {
					...
					while (ch) {
						...
						white();
						next(":");
						if (Object.hasOwnProperty.call(obj, key)) error("Duplicate key '" + key + "'");
						obj[key] = value();
						white();
						if (ch === "}") {
							next("}");
			...
			return function(source, reviver) {
				...
				return typeof reviver === "function" ? function walk(holder, key) {
					...
					if (val && typeof val === "object") {
						for (k in val) if (Object.prototype.hasOwnProperty.call(val, k)) {
							v = walk(val, k);
							if (v !== void 0) val[k] = v;
							else delete val[k];
						}
		...
		if (typeof module$1 === "object" && module$1.exports) module$1.exports = ___dougJSONParse;
		var jsonlint = (function() {
			var parser = {
			...
			parser.lexer = (function() {
				var lexer = {
					EOF: 1,
					parseError: function parseError(str, hash) {
						if (this.yy.parseError) this.yy.parseError(str, hash);
		...
		if (typeof require !== "undefined" && typeof exports$1 !== "undefined") {
			...
			exports$1.main = function commonjsMain(args) {
				...
				else var source = require("file").path(require("file").cwd()).join(args[1]).read({ charset: "utf-8" });
				return exports$1.parser.parse(source);
			};
			if (typeof module$1 !== "undefined" && require.main === module$1) exports$1.main(typeof process !== "undefined" ? process.argv.slice(1) : require("system").args);
		}
		return exports$1;
	})();
...
//# sourceMappingURL=jsonlint-mod.js.map